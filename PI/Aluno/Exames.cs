...
namespace PI
{
    public partial class Exames : Form
    {
        ...
        private void dg_conteudo_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex > 0)
            {
                MessageBox.Show(dg_conteudo.Rows[e.RowIndex].Cells[5].Value.ToString());
                pessoa.add1 = dg_conteudo.Rows[e.RowIndex].Cells[5].Value.ToString();
